    ...
    <>
      <AnimatePresence>
        ...
        <motion.div 
            ...
            className=" rounded-3xl overflow-hidden border border-stone-200 bg-white hover:bg-stone-100 transition-colors duration-100 p-3 min-w-[600px] cursor-pointer">
        {/* Image Section */}
